...
/* USER CODE BEGIN EV */
extern osSemaphoreId UptoBaseTransFinishHandle;
extern osSemaphoreId WT931TransFinishHandle;
extern osSemaphoreId GY39TransFinishHandle;
extern osSemaphoreId BasetoUpTransFinishHandleHandle;
extern osSemaphoreId DeepTransFinishHandleHandle;
extern osSemaphoreId P30TransFinishHandle;
/* USER CODE END EV */

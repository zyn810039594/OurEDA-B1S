...
/* Configure the peripherals common clocks */
  ...
  osThreadDef(CtrlTask, CtrlTaskF, osPriorityHigh, 0, 128);
  CtrlTaskHandle = osThreadCreate(osThread(CtrlTask), NULL);

  /* definition and creation of SensorTask */
  osThreadDef(SensorTask, SensorTaskF, osPriorityLow, 0, 128);
...
void InitialTaskF(void const * argument)
{
  /* USER CODE BEGIN InitialTaskF */
	...
	HAL_GPIO_WritePin(&GPIOE, GPIO_PIN_4, GPIO_PIN_RESET);
	HAL_UART_Receive_DMA(&huart1, UART1RX, UART1RXLen);

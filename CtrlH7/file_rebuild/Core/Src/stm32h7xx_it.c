...
/* USER CODE BEGIN EV */
extern osSemaphoreId UpSideFinishHandle;
extern osSemaphoreId DownSideFinishHandle;
extern osSemaphoreId DeepFinishHandle;
extern osSemaphoreId GY39FinishHandle;
extern osSemaphoreId WT931FinishHandle;
/* USER CODE END EV */
